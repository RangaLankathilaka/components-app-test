...
import com.noetic.pos.util.ActiveProfileReader;

/**
 * Runtime determination of the config for the deployment based on system
 * property.
 * <p>
...
public class DeployProfileConfigFactory {
	...
	public static DeployProfileConfig forEnvironment() {
		...
		if (deployProfileValue != null) {
			log.info("Attempting to run deployProfile on internal" + deployProfileValue);
		} else {
