...
import com.noetic.pos.config.dev.CommonConfig;
import com.noetic.pos.config.dev.MySQLConfig;

@Profile("DEV")
@Configuration
@EnableCaching
@EnableJpaRepositories(basePackages = {"com.noetic.upa.domain.repository"})
@EnableConfigurationProperties({MySQLConfig.class, CommonConfig.class})
@ComponentScan("com.noetic.upa.config")
